...
from app.api.dependencies import get_db, get_current_internal_user, get_current_user
...
def require_admin(current_user: User = Depends(get_current_internal_user)) -> User:
